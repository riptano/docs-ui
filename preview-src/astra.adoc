...
https://astra.datastax.com[Explore Astra Vector^,role="btn btn-primary btn-solid"]

https://astra.datastax.com[Create Astra Account^,role="btn btn-primary btn-outlined external"]

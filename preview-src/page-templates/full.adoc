...
[discrete.!m-0]
== [.rounded-xl.border.p-1.flex.w-max.mb-1]#icon:ROOT:ui/icons/astra-database.svg[]# Vector
...
[discrete]
== [.rounded-xl.border.p-1.flex.w-max.mb-1]#icon:ROOT:ui/icons/astra-database.svg[]# Serverless
...
[discrete]
== [.rounded-xl.border.p-1.flex.w-max.mb-1]#icon:ROOT:ui/icons/astra-streaming.svg[]# Streaming
